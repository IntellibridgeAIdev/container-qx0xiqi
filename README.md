...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qx0xiqi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qx0xiqi.containers.anotherwebservice.com/
...
```
git clone git@github.com:IntellibridgeAIdev/container-qx0xiqi.git
cd container-qx0xiqi
```
...
```
docker attach container-qx0xiqi
```
